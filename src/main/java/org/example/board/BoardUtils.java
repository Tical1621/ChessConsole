...
public class BoardUtils {
    //static для того чтобы не создавать повсюду экземпляр класса, а обращаться по имени класса
    public static List<Coordinates> getDiagonalCoordinatesBetween(Coordinates source, Coordinates target) {
        //допущение, что две клетки лежат на одной диагонали
        List<Coordinates> result = new ArrayList<>();
        //чтобы понять какой сдвиг-нужно сравнить вертикаль исходной ячейки и целевой==fileShift
